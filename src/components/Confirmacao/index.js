      ...
      >
        <View style={estilo.V_img}>
          <Image
            ...
            source={{
              uri:
                'https://firebasestorage.googleapis.com/v0/b/republicas.appspot.com/o/Group%20453%403x.png?alt=media&token=0c1081e3-fb91-4ab1-980f-2e82cc8b65cc',
            }}
          />
        </View>
        ...
        <View style={estilo.V_Subtitle}>
          <Text style={estilo.subtitle}>
            Iremos analisar seu anuncio e em algumas horas vc terá seu anuncio
            oline.
          </Text>
        </View>
