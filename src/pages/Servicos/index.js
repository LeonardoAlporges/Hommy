...
class Servicos extends Component {
  ...
  UNSAFE_componentWillMount (){
    return axios.get('https://backendhommy.herokuapp.com/servicos')
      .then((responseJson) => {this.setState({listaServicos: responseJson.data }); })
      .catch((error) =>{
  ...
  return (
    ...
    <ScrollView style={Estilo.card}> 
        <FlatList 
          ...
          renderItem={({item}) => <CartaoServico leonardo={item} ></CartaoServico>}
