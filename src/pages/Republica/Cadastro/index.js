...
export default function Cadastro({navigation}){
  ...
  function atualizarRepublica(dados){
    ...
    return (
      <Formik
        initialValues={{
          nome: dadosRepublica.titulo,
          bairro: dadosRepublica.bairro,
          rua: dadosRepublica.rua,
          numero: dadosRepublica.numeroCasa,
          aluguel: dadosRepublica.valorAluguel.toString(10),
          contas: dadosRepublica.valorContas.toString(10),
          moradores: dadosRepublica.pessoas,
          genero: dadosRepublica.genero,
          animais: dadosRepublica.animal,
          aQuarto: dadosRepublica.acomodacaoQuarto,
          aRepublica: dadosRepublica.acomodacaoRepublica,
          numeroVagas: dadosRepublica.numeroVagas,
          tipoImovel: dadosRepublica.tipoImovel,
          descricao: dadosRepublica.descricao,
        }}
        onSubmit={values => {
