    ...
    render() {
        return (
            <View style={estilo.container}>
                <Image source={{ uri: 'https://firebasestorage.googleapis.com/v0/b/republicas.appspot.com/o/leo.png?alt=media&token=82587fae-0527-42f4-8ba1-4f9d1d8e3395' }} style={{ width: 100, height: 100, marginTop: '10%' }} />
                <Text style={estilo.txt_Titulo}>Hoomy</Text>
                <Formik
                    initialValues={{ nome: '', email: '', confirmaEmail: '', password: '' }}
                    ...
                    {({ values, handleChange, errors, setFieldTouched, touched, isValid, handleSubmit }) => (
                        <Fragment >
                            <View style={estilo.view_CamposLogin}>
                                <Item >
                                    <Icon style={estilo.icons_CamposLogin} active name='md-person' />
                                    <Input
                            ...
                            <View style={estilo.view_CamposLogin}>
                                <Item >
                                    <Icon style={estilo.icons_CamposLogin} active name='ios-mail' />
                                    <Input
