...
import { Icon, Input, Fab, Item, Button, Container, Header,Spinner, Tabs, Tab } from 'native-base';
        ...
        return (
            ...
            <Container>
                ...
                <Tabs tabBarUnderlineStyle={{ backgroundColor: '#1DA1F2' }} >
                    ...
                    {this.state.loading 
?        <View style={{flex:1,justifyContent:'center',alignItems:'center'}}><Spinner color='rgba(29,161,242,1)'/></View>
:     <Text>OK</Text>}
